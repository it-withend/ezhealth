export const translations = {
  en: {
    ...
    profile: {
      ...
      enterContactManually: "Please enter contact details manually",
  ...
  ru: {
    ...
    profile: {
      ...
      enterContactManually: "Пожалуйста, введите данные контакта вручную",
  ...
  uz: {
    ...
    profile: {
      ...
      enterContactManually: "Iltimos, kontakt ma'lumotlarini qo'lda kiriting",
