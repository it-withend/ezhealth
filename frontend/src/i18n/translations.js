export const translations = {
  en: {
    ...
    profile: {
      ...
      contactTelegramPlaceholder: "Username, phone, or Telegram ID",
      selectFromTelegram: "Help",
      contactSelectionHelp: "To add a contact:\n\n1. Enter the contact's Telegram username (e.g., @username)\n2. Or enter their Telegram ID (numeric)\n3. Or enter their phone number\n\nYou can find a contact's username in their Telegram profile.",
      selectContactManually: "Please enter contact details manually",
      selectContactInstruction: "A chat will open. Please share the contact you want to add, then return here and enter the username or ID manually.",
      enterContactManually: "Please enter the contact's Telegram username (e.g., @username) or Telegram ID manually.",
  ...
  ru: {
    ...
    profile: {
      ...
      contactTelegramPlaceholder: "Имя пользователя, телефон или Telegram ID",
      selectFromTelegram: "Помощь",
      contactSelectionHelp: "Чтобы добавить контакт:\n\n1. Введите username контакта (например, @username)\n2. Или введите их Telegram ID (числовой)\n3. Или введите их номер телефона\n\nВы можете найти username контакта в его профиле Telegram.",
      selectContactManually: "Пожалуйста, введите данные контакта вручную",
      selectContactInstruction: "Откроется чат с ботом. Пожалуйста, используйте кнопку выбора контакта в боте, выберите контакт, а затем вернитесь сюда. Вы также можете ввести username или ID контакта вручную в поле ниже.",
      enterContactManually: "Пожалуйста, введите username (например, @username) или Telegram ID контакта вручную.",
  ...
  uz: {
    ...
    profile: {
      ...
      contactTelegramPlaceholder: "Foydalanuvchi nomi, telefon yoki Telegram ID",
      selectFromTelegram: "Yordam",
      contactSelectionHelp: "Kontakt qo'shish uchun:\n\n1. Kontaktning Telegram username ni kiriting (masalan, @username)\n2. Yoki ularning Telegram ID sini kiriting (raqamli)\n3. Yoki ularning telefon raqamini kiriting\n\nSiz kontaktning username ni uning Telegram profilida topishingiz mumkin.",
      selectContactManually: "Iltimos, kontakt ma'lumotlarini qo'lda kiriting",
      selectContactInstruction: "Bot bilan chat ochiladi. Iltimos, botdagi kontakt tanlash tugmasidan foydalaning, kontaktni tanlang va keyin bu yerga qayting. Siz shuningdek, kontaktning username yoki ID sini quyidagi maydonga qo'lda kiriting.",
      enterContactManually: "Iltimos, kontaktning username (masalan, @username) yoki Telegram ID sini qo'lda kiriting.",
